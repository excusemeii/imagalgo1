...
public final class tree_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("var imageArray = ['tree/t1.png','tree/t2.png','tree/t3.png','tree/t4.png','tree/t5.png','tree/t6.png','tree/t7.png','tree/t8.png',\r\n");
      out.write("'tree/t9.png','tree/t10.png','tree/t11.png'];\r\n");
      out.write("var steps = [\"Considering this input array, let's start tree sort\",\r\n");
      out.write("\"To begin with the sort, the first element (arr[i]) is converted into the root node of the binary tree. In this, one node can have atmost two children\",\r\n");
      out.write("\"Moving ahead through the list, the next element is inserted into thee binary tree. If it is less than root then it becomes left node else right node\", \"Insert element into the binary tree\",\r\n");
      out.write("\"Insert element into the binary tree\",\"Insert element into the binary tree\",\"Insert element into the binary tree\",\"Insert element into the binary tree\",\"Insert element into the binary tree\",\r\n");
      out.write("\"Now, the obtained binary tree is traversed in inorder\",\"The obtained order is fed back into the array. Now, the array is sorted!\"];\r\n");
      ...
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" >A tree sort is a sort algorithm that builds a binary search tree from the elements to be sorted, and then traverses the tree (in-order) so that the elements come out in sorted order. Its typical use is sorting elements online: after each insertion, the set of elements seen so far is available in sorted order.<br>\r\n");
      out.write("</br>\r\n");
      out.write("A tree sort works as follows: <br>\r\n");
      out.write("<b>Step 1:</b> Take the elements input in an array.<br>\r\n");
      out.write("<b>Step 2:</b> Create a Binary search tree by inserting data items from the array into the\r\n");
      out.write("        binary search tree.<br>\r\n");
      out.write("<b>Step 3:</b> Perform in-order traversal on the tree to get the elements in sorted order.\r\n");
      out.write("<br>\r\n");
      out.write("\r\n");
      out.write("</p>\r\n");
      out.write("<h2 style=\"font-size:23px;color:black;text-align:center\">Complexity</h2></b>\r\n");
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" ><b>Average Case Time Complexity :</b> O(n log n) Adding one item to a Binary Search tree on average takes O(log n) time. Therefore, adding n items will take O(n log n) time<br>\r\n");
      out.write("<b>Worst Case Time Complexity :</b> O(n^2). The worst case time complexity of Tree Sort can be improved by using a self-balancing binary search tree like Red Black Tree, AVL Tree. Using self-balancing binary tree Tree Sort will take O(n log n) time to sort the array in worst case.<br>\r\n");
      out.write("<b>Auxiliary Space :</b> O(n)\r\n");
      out.write("<br>\r\n");
      out.write("\r\n");
      out.write("</p>\r\n");
      out.write("<h2 style=\"font-size:23px;color:black;text-align:center\">Use</h2></b>\r\n");
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" >\r\n");
      out.write("â¢\tIts typical use is sorting elements online: after each insertion, the set of elements seen so far is available in sorted order.\r\n");
      out.write("<br>â¢\tWhen using a splay tree as the binary search tree, the resulting algorithm (called splaysort) has the additional property that it is an adaptive sort, meaning that its running time is faster than O(n log n) for inputs that are nearly sorted.\r\n");
      out.write("\r\n");
      out.write(" </br></br>\r\n");
      out.write("</p>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" >The algorithm for tree sort is shown as: \r\n");
      out.write("</br></br>\r\n");
      out.write("treeSort(array, size)</br> \r\n");
      out.write("   for 1:= 1 to size do\r\n");
      out.write("   <br> inserttree(arr[i])<br>\r\n");
      out.write("   end for<br>\r\n");
      out.write("   inordertraversal()  <br>\r\n");
      out.write("   \r\n");
      out.write("   done <br>\r\n");
      out.write("<br>\r\n");
      out.write("<br>\r\n");
