...
public final class gnome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("var imageArray = ['gnome/g1.png','gnome/g2.png','gnome/g3.png','gnome/g4.png','gnome/g5.png','gnome/g6.png','gnome/g7.png','gnome/g8.png',\r\n");
      out.write("'gnome/g9.png','gnome/g10.png','gnome/g11.png','gnome/g12.png','gnome/g13.png','gnome/g14.png','gnome/g15.png','gnome/g16.png','gnome/g17.png',\r\n");
      out.write("'gnome/g18.png','gnome/g19.png','gnome/g20.png','gnome/g21.png','gnome/g22.png','gnome/g23.png','gnome/g24.png','gnome/g25.png','gnome/g26.png',\r\n");
      out.write("'gnome/g27.png','gnome/g28.png','gnome/g29.png','gnome/g30.png','gnome/g31.png','gnome/g32.png','gnome/g33.png','gnome/g34.png','gnome/g35.png',];\r\n");
      out.write("var steps = [\"Considering this input array, let's start gnome sort proceeding from left to right\",\r\n");
      out.write("\"To begin with the sort, the first element (arr[i]) is compared with the next adjacent element (arr[i+1])\",\r\n");
      out.write("\"If the first element is greater , they are swapped\",\"The next element is compared with its adjacent element\",\r\n");
      out.write("\"The next element is compared with its adjacent element\",\"The element seems greater hence, it is swapped\",\r\n");
      out.write("\"The element seems greater hence, it is swapped.\",\"As swapping happens, the array is traced backwards, the element arr[i] is compared with arr[i-1].If no change, the array proceeds with the place where it left earlier\",\r\n");
      out.write("\"The next element is compared with its adjacent element\",\"The element seems greater hence, it is swapped\",\"As swapping happens, the array is traced backwards, the element arr[i] is compared with arr[i-1]\",\r\n");
      out.write("\"The element seems smaller hence, it is swapped\",\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]. If no change, the array proceeds with the place where it left earlier in the forward tracing\",\r\n");
      out.write("\"The next element is compared with its adjacent element\",\"The element seems greater hence, it is swapped\",\"As swapping happens, the array is traced backwards, the element arr[i] is compared with arr[i-1]\",\r\n");
      out.write("\"The element seems smaller hence, it is swapped\",\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]\",\"The element seems smaller hence, it is swapped\",\r\n");
      out.write("\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]\",\"The element seems smaller hence, it is swapped\",\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]\",\r\n");
      out.write("\"The element seems smaller hence, it is swapped. Now, as no more elements exist previous to this position therefore, the index where the forward tracing left is picked from\",\r\n");
      out.write("\"The next element is compared with its adjacent element\",\"The element seems greater hence, it is swapped\",\"As swapping happens, the array is traced backwards, the element arr[i] is compared with arr[i-1]\",\r\n");
      out.write("\"The elements are in order therefore, pick up where forward tracing was stopped\",\r\n");
      out.write("\"The next element is compared with its adjacent element\",\"The element seems greater hence, it is swapped\",\"As swapping happens, the array is traced backwards, the element arr[i] is compared with arr[i-1]\",\r\n");
      out.write("\"The element seems smaller hence, it is swapped\",\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]\",\"The element seems smaller hence, it is swapped\",\r\n");
      out.write("\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]\",\"The element seems smaller hence, it is swapped\",\"As swapping happens, the array is again traced backwards, the element arr[i] is compared with arr[i-1]\",\r\n");
      out.write("\"The elements are in order therefore, no change. Now, as the end is reached, the traversal ends\", \"Now, the array is sorted!\"];\r\n");
      ...
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" >The gnome sort is a sorting algorithm which is similar to insertion sort in that it works with one item at a time but gets the item to the proper place by a series of swaps, similar to a bubble sort. It is conceptually simple, requiring no nested loops. \r\n");
      out.write("</br>\r\n");
      out.write("Gnome Sort also called Stupid sort is based on the concept of a Garden Gnome sorting his flower pots. Here is how a garden gnome sorts a line of flower pots. <br>\r\n");
      out.write("Basically, he looks at the flower pot next to him and the previous one; if they are in the right order he steps one pot forward, otherwise, he swaps them and steps one pot backward. \r\n");
      out.write("<br>Boundary conditions: if there is no previous pot, he steps forwards; if there is no pot next to him, he is done.\r\n");
      out.write("\r\n");
      out.write("<br>\r\n");
      out.write("The algorithm finds the first place where two adjacent elements are in the wrong order and swaps them. It takes advantage of the fact that performing a swap can introduce a new out-of-order adjacent pair next to the previously swapped elements. It does not assume that elements forward of the current position are sorted, so it only needs to check the position directly previous to the swapped elements\r\n");
      out.write("</p>\r\n");
      out.write("<b></b><h2 style=\"font-size:23px;color:black;text-align:center\">Complexity</h2></b>\r\n");
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" ><b>Worst-case performance :</b> O(n^{2}) <br>\r\n");
      out.write("<b>Best-case performance :</b> O(n) <br>\r\n");
      out.write("<b>Average performance : </b> O(n^{2}) <br>\r\n");
      out.write("<b>Worst-case space complexity :</b>  O(1) auxiliary <br>\r\n");
      out.write("\r\n");
      out.write("</br> \r\n");
      out.write("\r\n");
      out.write("</p>\r\n");
      ...
      out.write("<p class=\"card-text\" style=\"font-size:17px;\" >The algorithm for gnome sort is shown as: \r\n");
      out.write("</br></br>\r\n");
      out.write("gnomeSort(arr,size)<br>\r\n");
      out.write("    i := 1<br>\r\n");
      out.write("    j := 2<br>\r\n");
      out.write("    while i < size do <br>\r\n");
      out.write("        if a[i-1] <= a[i] then <br>\r\n");
      out.write("            // for descending sort, >= <br>\r\n");
      out.write("            i := j<br>\r\n");
      out.write("            j := j + 1 <br>\r\n");
      out.write("        else<br>\r\n");
      out.write("            swap a[i-1] and a[i]<br>\r\n");
      out.write("            i := i - 1<br>\r\n");
      out.write("            if i = 0 then<br>\r\n");
      out.write("                i := j<br>\r\n");
      out.write("                j := j + 1<br>\r\n");
      out.write("            endif<br>\r\n");
      out.write("        endif<br>\r\n");
